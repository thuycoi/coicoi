...
class ExamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create example" do
    assert_difference('Example.count') do
      post examples_url, params: { example: { body: @example.body, definition_id: @example.definition_id } }
    end
  ...
  test "should update example" do
    patch example_url(@example), params: { example: { body: @example.body, definition_id: @example.definition_id } }
