...
class FavouritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favourite" do
    assert_difference('Favourite.count') do
      post favourites_url, params: { favourite: { user_id: @favourite.user_id, word_id: @favourite.word_id } }
    end
  ...
  test "should update favourite" do
    patch favourite_url(@favourite), params: { favourite: { user_id: @favourite.user_id, word_id: @favourite.word_id } }
